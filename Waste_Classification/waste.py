...
app = Flask("Waste_Classification_Model", template_folder="Waste_Classification\\templates")
model = keras.models.load_model('Waste_Classification\\Waste_Classification_Model.h5')
